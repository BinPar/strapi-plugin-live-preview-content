...
module.exports = {
    ...
    getPreviewUrl: function (contentType, contentId, _query) {
        var _a;
        return __awaiter(this, void 0, void 0, function () {
            var contentTypeModel, contentTypeConfig, entity, previewUrl, baseUrl, additionalValues;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        entity = _b.sent();
                        previewUrl = (contentTypeConfig === null || contentTypeConfig === void 0 ? void 0 : contentTypeConfig.url) || entity.previewUrl || "";
                        baseUrl = entity.baseUrl || "";
                        additionalValues = {};
                        if (!(contentTypeConfig === null || contentTypeConfig === void 0 ? void 0 : contentTypeConfig.usesValuesInUrl)) return [3 /*break*/, 3];
                        return [4 /*yield*/, strapi.query(contentType).findOne({ id: contentId })];
                    case 2:
                        // Fetch the data
                        // @ts-ignore
                        additionalValues = _b.sent();
                        _b.label = 3;
                    case 3: return [2 /*return*/, this.replacePreviewParams(baseUrl, contentType, contentId, previewUrl, additionalValues)];
                }
            });
        });
    },
     ...
     */
    replacePreviewParams: function (baseUrl, contentType, contentId, url, additionalValues) {
        return lodash_1.default.template(url
            .replace(":baseUrl", baseUrl)
            .replace(":contentType", contentType)
            .replace(":id", contentId))(additionalValues);
    },
    /**
